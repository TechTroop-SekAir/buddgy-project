...
export function OnboardingPage() {
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-2xl flex-col justify-center px-4 py-12">
      <h1 className="mb-1 text-2xl font-semibold tracking-tight text-text-primary">{t('onboarding.title')}</h1>
      ...
      <div className="rounded-lg border border-border-card bg-bg-surface p-6 shadow-sm">

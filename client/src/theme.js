...
// A function, not a module-level const: it must re-read the CSS custom
// properties (and therefore be re-called) whenever data-theme flips, since
// Mantine's color arrays are baked hex strings, not var() references — see
// src/context/ThemeContext.jsx for how the caller ensures data-theme is
// already updated before this runs.
